...
INSERT INTO DEL_MEMBER(EMAIL, PASSWORD, NICK, AUTHORITY) VALUES('ADMIN90', '1234', '관리자90', 'Y');
...
INSERT INTO DEL_BOARD(NO, WRITER, CATEGORY_NO, TITLE, CONTENT,  SECRET_YN, NOTICE_YN) VALUES(SEQ_BOARD.NEXTVAL , 'ADMIN99', 1, '게시글 1', '내용 1', 'N', 'Y');
INSERT INTO WARNING_LIST(NO, TITLE, POINT) VALUES(1, '욕설', 5);
INSERT INTO WARNING_NUM(NO, EMAIL, WARNING_NO, WARNING_NUM) VALUES(SEQ_WARNING_NUM.NEXTVAL, 'ADMIN99', 1, 1);
...
SELECT * FROM MEMBER ORDER BY EMAIL DESC;

DELETE FROM MEMBER WHERE EMAIL = 'ADMIN99' ;
COMMIT;
