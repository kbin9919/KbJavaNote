...
---------------------------------------------------
-- 탈퇴 회원 시퀀스 
CREATE SEQUENCE SEQ_QUIT_MEMBER;
-- 팔로잉 시퀀스 
...
-- 누적 경고 횟수 외래키 
ALTER TABLE WARNRING_NUM ADD CONSTRAINT FK_WARNING_NUM_MEMBER FOREIGN KEY (EMAIL) REFERENCES MEMBER(EMAIL);
...
--------------------- 데이터 -----------------------
---------------------------------------------------
INSERT INTO MEMBER(EMAIL, PASSWORD, NICK, AUTHORITY) VALUES('ADMIN99', '1234', '관리자1', 'Y');
INSERT INTO BOARD(NO, WRITER, CATEGORY_NO, TITLE, CONTENT,  SECRET_YN, NOTICE_YN) VALUES(SEQ_BOARD.NEXTVAL , 'ADMIN99', 1, '게시글 1', '내용 1', 'N', 'Y');
DELETE MEMBER;
SELECT * FROM MEMBER WHERE EMAIL = 'ADMIN99' AND PASSWORD = '1234' AND AUTHORITY = 'Y';
SELECT * FROM BOARD ORDER BY NO DESC;
SELECT * FROM BOARD WHERE TITLE = '게시글 1' ORDER BY NO DESC;
COMMIT;
