...
/* EX )
    ...
    ...
*/
SELECT DEPARTMENT_NAME ||'의 정원은 ' ||CAPACITY || '입니다.' AS "학과/정원"
FROM TB_DEPARTMENT;
...
FROM TB_STUDENT
WHERE SUBSTR (ENTRANCE_DATE, 2,1) = 2 AND SUBSTR (STUDENT_ADDRESS, 1, 3) = '전주시' and ABSENCE_YN = 'N';
