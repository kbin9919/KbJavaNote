...
public class MemberVo {
	...
	public MemberVo(String email, String password, String nick, String enrollDate, String modifyDate,
	...
	public String toString() {
		return "MemberVo [email=" + email + ", password=" + password + ", nick=" + nick + ", enrollDate=" + enrollDate
